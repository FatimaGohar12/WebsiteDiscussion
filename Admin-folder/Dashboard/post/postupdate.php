        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Posted_by By </label>
                        <input type="text" class="form-control rounded-0 mx-2" name="posted_by" id="posted_by" value="<?php echo "$updatename" ?>">
                    </div>
...
if (isset($_POST['submit'])) {
   ...
   var_dump($title = $_POST['title']);

    // $sql2 = "UPDATE posts t1
    // JOIN users t2 ON t1.post_user_id = t2.sno
    // SET t1.post_title = " .$title. ", t1.post_content = ".$content.", t2.user_email = " .$name. " WHERE t1.post_id = $post_id";
    
    // $sql2="UPDATE posts SET post_title =".$title." , post_content =".$content." WHERE post_id = $post_id";
