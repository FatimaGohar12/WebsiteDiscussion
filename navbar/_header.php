...
<body>
  ...
  if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    echo '
        ...
        <li class="nav-item">
        <a  class="nav-link text-white" href="http://localhost/Forum2/Posthandel//Mypost.php" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sticky" viewBox="0 0 16 16">
