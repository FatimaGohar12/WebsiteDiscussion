...
<body>
    ...
    ($row = mysqli_fetch_assoc($result)) {
        ...
        //Query write to fetch user table to find name of the poster
         $sql2 = "SELECT posts.*,users.* FROM posts LEFT  JOIN users ON posts.post_user_id=users.sno";
...
$sql="INSERT INTO `postscomment` (`comment_content`, `comment_user_id`, `time`, `comment_post_id`) VALUES ('$comment', '$sno', CURRENT_TIMESTAMP, '$id')";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    '<div class="container">
        <div class="media ">
        <img src="./userdeafult.jpg" alt="" width="30" class="mx-2">' .$posted_by.'
       
            <div class="media-body my-2">
                
                <p class="lead" display-6 ">'.$content.'</p>
